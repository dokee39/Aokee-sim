syms l_a l_b l_c varphi_1(t) varphi_2(t) varphi_B_1(t) varphi_B_2(t) dot_varphi_1 dot_varphi_2 theta_l l
...
J = simplify([sin(theta_l) cos(theta_l); (cos(theta_l) / l), -(sin(theta_l) / l)] * J_qx)
